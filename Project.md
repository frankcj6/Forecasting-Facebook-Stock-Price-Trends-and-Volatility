...
12/11/2020
  ...
  - [Description](#description)
      - [Business Interest and
        background](#business-interest-and-background)
  - [Data](#data)
      - [Dataset](#dataset)
  ...
  - [Result and Analysis](#result-and-analysis)
      ...
      - [ARIMA](#arima)
      - [ARIMA Model Fitting &
        evaluation](#arima-model-fitting-evaluation)
      - [ARMA-GARCH](#arma-garch)
      - [Forecasting](#forecasting)
      - [Evaluation & Validation](#evaluation-validation)
      - [Deep Learning: Feed Foward Neural
        Network](#deep-learning-feed-foward-neural-network)
